...
| ERR-003 | [003_index-js-missing-android.md](./003_index-js-missing-android.md) | expo-router entry 설정과 `index.js` 브리지 혼동 | expo-router + native build |
...
- 웹 지원 시 `app.json`의 `expo.web.bundler = "metro"` 확인

### EAS Dev Client / Android 빌드 체크리스트
- `package.json`의 `main = expo-router/entry` 확인 → ERR-003
